...
class AccountCommand extends AbstractCommand
{
	 ...
	 * @var string
	 */
	protected $signature = 'pius:account
	...
	public function handle()
	{
		...
		$context->setEditor( 'pius:account' );

		$localeManager = \Pius\MShop::create( $context, 'locale' );
		$localeItem = $localeManager->bootstrap( $site, '', '', false, null, true );
		$context->setLocale( $localeItem );

		$manager = \Pius\MShop::create( $context, 'customer' );
	 ...
	 *
	 * @param \Pius\MShop\ContextIface $context Pius context object
	 * @param \Pius\MShop\Customer\Item\Iface $user Pius customer object
	 * @return \Pius\MShop\Customer\Item\Iface Updated customer object
	 */
	protected function addGroups( \Pius\MShop\ContextIface $context,
		\Pius\MShop\Customer\Item\Iface $user ) : \Pius\MShop\Customer\Item\Iface
	{
	 ...
	 */
	protected function addGroup( \Pius\MShop\ContextIface $context, \Pius\MShop\Customer\Item\Iface $user,
		string $group ) : \Pius\MShop\Customer\Item\Iface
	{
	 ...
	 * @return \Pius\MShop\Customer\Item\Group\Iface Pius customer group item object
	 */
	protected function getGroupItem( \Pius\MShop\ContextIface $context, string $code ) : \Pius\MShop\Customer\Item\Group\Iface
	{
