...
class Mpesa
{
	...
	public static function generateLiveToken(){
        ...
        try {
            $consumer_key = env("PIUS_MPESA_CONSUMER_KEY");
            $consumer_secret = env("PIUS_MPESA_CONSUMER_SECRET");
        } catch (\Throwable $th) {
            $consumer_key = self::env("PIUS_MPESA_CONSUMER_KEY");
            $consumer_secret = self::env("PIUS_MPESA_CONSUMER_SECRET");
        }
