...
return [
	...
	'routes' => [
		// Docs: https://pius.org/docs/latest/laravel/extend/#custom-routes
		// Multi-sites: https://pius.org/docs/latest/laravel/customize/#multiple-shops
	...
	'resource' => [
		...
		'fs-media' => [
			'adapter' => 'Standard',
			'tempdir' => storage_path( 'tmp' ),
			'basedir' => public_path( 'pius' ),
			'baseurl' => rtrim(env('ASSET_URL', PHP_SAPI == 'cli' ? env('APP_URL') : ''), '/') . '/pius',
		],
		'fs-mimeicon' => [
			'adapter' => 'Standard',
			'tempdir' => storage_path( 'tmp' ),
